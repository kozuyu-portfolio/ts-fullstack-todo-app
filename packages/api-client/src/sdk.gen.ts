...
export const eventControllerNonHttpEventTrigger = <ThrowOnError extends boolean = false>(options?: Options<EventControllerNonHttpEventTriggerData, ThrowOnError>) => {
